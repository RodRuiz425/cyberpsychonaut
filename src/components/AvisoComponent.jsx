      ...
      {isOpen && (
        <div className="modal">
          <div className="modal-content">
            <h5>¡AVISO! (+18)</h5>
            <p>Este sitio es exclusivo para adultos. Te recordamos que el contenido de este sitio web puede abordar temas sensibles y estar sujeto a discusión sobre una amplia gama de perspectivas.
